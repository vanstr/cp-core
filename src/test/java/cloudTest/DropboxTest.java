...
public class DropboxTest {
    ...
    @Test
    public void testGetUserAccessTokens() throws Exception {
    ...
    public void testGetFileList() throws Exception {
        ...
        // unworked
        ArrayList<String> res5 = dropUnAuth.getFileList("/", true, ".mp3");
        assertNull("Exception", res5);

        // 2.
        ArrayList<String> res = dropAuth.getFileList("/", true, ".mp3");
